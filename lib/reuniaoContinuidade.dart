...
class ReuniaoContinuidade extends StatefulWidget {
  @override
  _ReuniaoContinuidadeState createState() => _ReuniaoContinuidadeState();
}
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(child: Text("Reunião de continuidade")),
              ),
            ],
          ),
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Text("Reuniões sobrestadas", style: TextStyle(
                      color: Color(0xFF2c3e50),
                      fontSize: 15.0,
                      fontWeight: FontWeight.bold
                  ),),
              ...
              Container(
                ...
                child: Center(
                  child: DropdownButton(
                    ...
                    value: selectedType,
                    isExpanded: false,
                    hint: Text('Selecione reunião sobrestada',
                      style: TextStyle(
                        color: Color(0xFF2c3e50),
                        fontSize: 13.0,
                      ),
